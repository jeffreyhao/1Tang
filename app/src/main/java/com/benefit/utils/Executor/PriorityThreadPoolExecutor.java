package com.benefit.utils.Executor;
...
public class PriorityThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public PriorityThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime,
                                      TimeUnit unit, PriorityBlockingQueue<Runnable> taskQueue, ThreadFactory threadFactory) {
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, taskQueue, threadFactory);
    }
