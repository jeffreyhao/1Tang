package com.benefit.utils.defenceLib.core;
...
public class DefenseInstrumentation extends Instrumentation {
    ...
    private void callException(Exception e) {
        ALog.crash("DefenseInstrumentation", "callException", e);
        if (mExceptionDispatcher != null) {
            mExceptionDispatcher.uncaughtExceptionHappened(Looper.getMainLooper().getThread(), e, DefenseCore.isInSafeMode());
        }
    }
