...
/**
 * @author: yuhaibo
 * @time: 2018/8/12 上午11:02.
 * 
 * Description: Solve textView early line breaks
 */
public class MTextView extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mCharacterSpace = ta.getDimensionPixelSize(ta.getIndex(R.styleable.MTextView_character_space), 0);
        ...
        ellipStr = ta.getString(R.styleable.MTextView_end_str);
        ta.recycle();
